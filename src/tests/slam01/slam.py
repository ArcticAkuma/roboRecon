...
from src.tests.slam.post_process import post_process_speed_and_yaw
...
def hybrid_rgbd_odometry(
    ...
    """
    if backward:
        success_list, yaw_list, distance_list = hybrid_rgbd_odometry(rgbd_image_list[::-1], intrinsic_matrix,
                                                                     use_tqdm=use_tqdm, backward=False)
    ...
    for i in range_generator:
        ...
        try:
            ...
            success, yaw_from_start, distance_from_start = odom_extract_opencv_pnpransac(good_3d, good_new,
                                                                                         intrinsic_matrix)
...
def run_batch(
    ...
    success_list, yaw_list, distance_list = hybrid_rgbd_odometry(rgbd_image_list, intrinsics, use_tqdm=False,
                                                                 backward=False)
...
if __name__ == "__main__":
    cli()
    # Example usage:
    # python3 slam01.py ../sequence/ ../sequence/ ../output.csv ../processed.csv --batch_size 10 --video_frame_rate 30.0